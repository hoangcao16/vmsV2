...
function TableGroupCameraPermission({ id, dispatch, listCameraGroupPermission, metadata }) {
  const intl = useIntl();
...
function mapStateToProps(state) {
  const { listCameraGroupPermission, metadata } = state.groupCameraPermissionInGroupUser;
  return {
