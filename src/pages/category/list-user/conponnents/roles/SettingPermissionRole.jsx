...
function SettingPermissionRole({ dispatch, data, treeNodeList, checked, openDrawer, onClose }) {
  ...
  useEffect(() => {
    dispatch({
      type: 'premissionInRole/fetchAllPermission',
      payload: {
  ...
  const handleSubmit = async () => {
    ...
    if (!isEmpty(dataAdd)) {
      dispatch({
        type: 'premissionInRole/setPermisionRole',
    ...
    if (!isEmpty(dataRemove)) {
      dispatch({
        type: 'premissionInRole/removePermisionRole',
...
function mapStateToProps(state) {
  const { allPermission, list } = state.premissionInRole;
  return {
...
export default connect(mapStateToProps)(SettingPermissionRole);
