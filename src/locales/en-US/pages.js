export default {
    ...
    'pages.home.hardDriveWarning': 'Hard drive {name} has been used {percentUsed}%. Estimated remaining usable time: {estimatedTime}.',
    ...
    'pages.report.chart.detailReport': 'List of traffic violations',
    ...
    'pages.setting-user.list-user.setPermisionCameraGroupSuccess': 'Setting Permision Camera Group Success',
    'pages.setting-user.list-user.removePermisionCameraGroupSuccess': 'Remove Permision Camera Group Success',
