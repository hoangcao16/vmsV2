export default {
    ...
    'pages.home.hardDriveWarning': 'Ổ cứng {name} đã được sử dụng {percentUsed}%. Thời gian dự kiến còn lại: {estimatedTime}.',
    ...
    'pages.report.chart.detailReport': 'Danh sách vi phạm giao thông',
    ...
    'pages.setting-user.list-user.setPermisionCameraGroupSuccess': 'Thêm quyền cho nhóm camera thành công',
    'pages.setting-user.list-user.removePermisionCameraGroupSuccess': 'Xóa quyền cho nhóm camera thành công',
