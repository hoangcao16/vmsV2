export default {
  ...
  'report.export.failedSent': 'Gửi báo cáo thất bại',
  ...
  'pages.live-mode.noti.name-favorite': 'Sửa thành công tên màn hình yêu thích',
  'pages.live-mode.noti.name-already': 'Tên màn hình đã tồn tại',
  'pages.live-mode.noti.choose-camera-to-preset': 'Chọn và cài đặt Preset để xem Camera',
  'pages.live-mode.noti.manage-preset-presetour': 'Quản lí preset, preset tour',
  'pages.live-mode.noti.manage-preset-presetour-description': 'Chuyển từ Preset qua Preset tour',
  'pages.live-mode.noti.control-panel': 'Bảng điểu khiển',
  'pages.live-mode.noti.control-panel-description': 'Điều chỉnh góc quay Camera',
  'pages.live-mode.noti.add-preset': 'Thêm preset',
  'pages.live-mode.noti.add-preset-tour': 'Thêm preset tour',
  'pages.live-mode.noti.edit-preset': 'Sửa preset',
  'pages.live-mode.noti.list-of-tour-presets': 'Danh sách preset tour',
  'pages.live-mode.noti.button-edit': 'Edit',
  'pages.live-mode.noti.button-delete': 'Delete',
  'pages.live-mode.noti.details-preset': 'View detailed presets',
  'pages.live-mode.noti.details-preset-tour': 'View detailed presets tour',
  'pages.live-mode.noti.user-create': 'User created',
};
